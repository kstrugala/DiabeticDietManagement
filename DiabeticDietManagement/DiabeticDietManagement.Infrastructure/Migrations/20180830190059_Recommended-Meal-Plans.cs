...
{
    public partial class RecommendedMealPlans : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GlycemicIndex = table.Column<long>(nullable: false),
                    GlycemicLoad = table.Column<long>(nullable: false),
                    ServeSize = table.Column<long>(nullable: false),
                    Carbohydrates = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
