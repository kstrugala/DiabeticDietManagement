...
namespace DiabeticDietManagement.Infrastructure.Services
{
    public class HandlerTask : IHandlerTask
    {
        ...
        private Func<CustomException, Task> _onCustomErrorAsync;
        private Func<CustomException, Logger, Task> _onCustomErrorWithLoggerAsync;
        ...
        public IHandlerTask OnCustomError(Func<CustomException, Task> onCustomError,
        ...
        public IHandlerTask OnCustomError(Func<CustomException, Logger, Task> onCustomError,
            bool propagateException = false, bool executeOnError = false)
        {
